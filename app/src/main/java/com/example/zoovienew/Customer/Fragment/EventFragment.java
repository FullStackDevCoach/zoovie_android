...
import com.example.zoovienew.Customer.Adapter.HostsItemLoungeEventAdapter;
import com.example.zoovienew.Customer.Model.LoungeTimeModel;
import com.example.zoovienew.R;
import com.example.zoovienew.databinding.FragmentEventBinding;
...
public class EventFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.rvLoungeTime.setAdapter(new HostsItemLoungeEventAdapter(dataHolder, getActivity()));
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.tv_see_all){
            Fragment fragment = new EventViewAllFragment();
