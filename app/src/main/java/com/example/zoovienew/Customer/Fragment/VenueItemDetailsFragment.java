...
public class VenueItemDetailsFragment extends Fragment implements View.OnClickListener{
    private FragmentVenueItemDetailsBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentVenueItemDetailsBinding.inflate(getLayoutInflater());
        binding.btnTicketPlay.setOnClickListener(this);
