...
public class HostsItemViewPagerAdapter extends FragmentPagerAdapter {
    //to keep track on tabs
    private int tabNumber;

    public HostsItemViewPagerAdapter(@NonNull FragmentManager fm, int behavior, int tabs) {
        super(fm, behavior);
        this.tabNumber =  tabs;
    }
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            ...
            case 0:
                return new HostConnectionsFragment();
            case 1:
                return new HostProgressFragment();
